...
export function yuParser(
  ...
  return {
    ...
    indent(_state, _textAfter, cx) {
      if (cx.pos === 0) return 0;
      const prev = cx.lineAt(cx.pos - 1);
...
import { yuCompletions, yuLanguage } from './yu-lang.ts';
