...
Expected: 11 tests pass. If one fails, find the cause with superpowers:systematic-debugging, fix the page (not the test's intent) and run again.
...
Expected: 11 tests pass against the live site; the screenshots show Studio 2.
