...
```svg
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="Yu"><rect width="64" height="64" fill="#279f7c"/><path fill="#fff" d="M5.5 36h6l1.25 2.9L14 36h6l-4.55 10.5v9.3h-5.4v-9.3zM25.3 36h5.4v11.8a2.6 2.6 0 0 0 5.2 0V36h5.4v11.8a8 8 0 0 1-16 0z"/></svg>
```
